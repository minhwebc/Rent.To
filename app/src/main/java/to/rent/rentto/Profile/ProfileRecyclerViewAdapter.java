...
//                                                            Toast.makeText(mContext, "Message deleted", Toast.LENGTH_SHORT).show();
        ...
        private void showDialog() {
            new AppRatingDialog.Builder()
                    ...
                    .setHint("Please write something you want to be reminded here about the item. Things such as when to return by and the agreement between you two. We will send you both a reminder")
